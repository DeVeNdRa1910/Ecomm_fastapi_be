...
from app.schemas.auth_schema import RegisterUser, UserResponse, LoginUser, OtpValidator, ChangePassword, ForgotPassword, OtpForgotPassword
from app.controllers.auth_controller import resister_controller, login_controller, verify_email, resend_otp_controller, logged_in_user_info, change_password_controller, forgot_password_otp_controller, forgot_password_controller
...
async def change_password(data: ChangePassword, current_user=Depends(get_current_user_by_token), db = Depends(get_db)):
